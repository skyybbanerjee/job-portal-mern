...
const ApplyJob = () => {
  ...
  const [isAlreadyAppplied, setIsAlreadyApplied] = useState(false);
  const {
    jobs,
    backendUrl,
    userData,
        ...
        <div className="bg-white text-black rounded-lg w-full">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-500 p-2.5 px-10 text-white rounded">
                {isAlreadyAppplied ? "Already Appplied" : "Apply Now"}
              </button>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3">
              ...
              <button
                onClick={applyHandler}
                className="bg-blue-600 hover:bg-blue-500 p-2.5 px-10 text-white rounded mt-10">
                {isAlreadyAppplied ? "Already Appplied" : "Apply Now"}
              </button>
            </div>
            {/* RIGHT SECTION ➡️ MORE JOBS */}
              ...
              {jobs
                ...
                .filter((job) => {
                  ...
                  const appliedJobIds = new Set(
                    userApplications.map((app) => app.jobId && app.jobId._d)
                  );
