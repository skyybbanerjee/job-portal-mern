...
const ViewApplications = () => {
  ...
  async function fetchCompanyJobApplications() {
    try {
      ...
      console.log(data);
      if (data.success) {
        // Ensure data.applicants is an array before reversing
        setApplicants(
          Array.isArray(data.applicants) ? data.applicants.reverse() : []
        );
        console.log("ViewApplications:", data.applicants);
      } else {
        toast.error(data.message);
        console.log("ViewApplications:", data);
      }
    } catch (error) {
      toast.error(error.message);
      console.log("ViewApplications:", error);
    }
  }
